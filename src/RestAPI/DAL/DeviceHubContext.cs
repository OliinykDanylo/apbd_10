...
public partial class DeviceHubContext : DbContext
{
    public DeviceHubContext()
    {
    }

    public DeviceHubContext(DbContextOptions<DeviceHubContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DeviceType>(entity =>
        {
            ...
            entity.HasIndex(e => e.Name, "UQ__DeviceTy__737584F6BCCFEC19").IsUnique();
        ...
        modelBuilder.Entity<Person>(entity =>
        {
            ...
            entity.HasIndex(e => e.PassportNumber, "UQ__Person__45809E71ADCFA416").IsUnique();

            entity.HasIndex(e => e.PhoneNumber, "UQ__Person__85FB4E386D70BF10").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Person__A9D10534CCB50D59").IsUnique();
        ...
        modelBuilder.Entity<Position>(entity =>
        {
            ...
            entity.HasIndex(e => e.Name, "UQ__Position__737584F68EE8EA59").IsUnique();
